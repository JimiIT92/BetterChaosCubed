...
/**
 * Implementation class for a sulfur fire block
 */
public final class SulfurFireBlock extends BaseFireBlock {

    /**
     * The {@link MapCodec<SulfurFireBlock> Copper Fire Block} Codec
     */
    ...
    public static boolean canSurviveOnBlock(final BlockState state) {
        return state.is(BCCTags.BlockTags.SULFUR_FIRE_BASE_BLOCKS);
    }
